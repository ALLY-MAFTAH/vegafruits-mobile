...
class _OrderDetailsState extends State<OrderDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var item in dataProvider.selectedOrder.items!) {
      totalAmount = totalAmount + item.price!;
    }
    DateTime formattedDate1 = DateTime.parse(dataProvider.selectedOrder.date!);
    DateTime formattedDate2 =
        DateTime.parse(dataProvider.selectedOrder.deliveryDate!);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(dataProvider.selectedOrder.number!),
      ),
      body: Builder(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      text:
                                          "${dataProvider.selectedOrder.customer!.name}",
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      text:
                                          "${dateFormat.format(formattedDate2)} at ${dataProvider.selectedOrder.deliveryTime}",
                                      style: TextStyle(fontWeight: FontWeight.bold),
                                    ),
                                  ],
                                ),
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      text:
                                          "${dataProvider.selectedOrder.deliveryLocation}",
                                      style: TextStyle(fontWeight: FontWeight.bold),
                                    ),
                                  ],
                                ),
                            ...
                            Column(
                              children: dataProvider.selectedOrder.items!
                                  .map((item) => Row(
                            ...
                            Row(
                              ...
                              children: [
                                    ...
                                    onPressed: () {
                                      setState(() {
                                        dataProvider.launchPhoneDialer(
                                            'tel:${dataProvider.selectedOrder.customer!.mobile}');
                                        dataProvider.updateOrderIsContacted(
                                            dataProvider.selectedOrder.id!);
                                      });
                                      refreshUI();
                                ...
                                Padding(
                                  ...
                                  child: dataProvider.selectedOrder.isPaid == 1
                                      ? Container()
                                    ...
                                    onPressed: () {
                                      setState(() {
                                        dataProvider.launchMessagingApp(
                                            'sms:${dataProvider.selectedOrder.customer!.mobile}');
                                        dataProvider.updateOrderIsContacted(
                                            dataProvider.selectedOrder.id!);
                                      });
                                      refreshUI();
                            ...
                            dataProvider.selectedOrder.wasContacted == 0
                                ? Container()
                                : Align(
                                    alignment: Alignment.center,
                                    child: Padding(
                            ...
                            Center(
                              child: SwipeButton(
                                ...
                                onSubmitted: () => dataProvider.updateOrderIsServed(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              decoration: BoxDecoration(
                                  color: dataProvider.selectedOrder.isPaid == 1
                                      ? Colors.green
                                      : Colors.red,
                              ...
                              child: Center(
                                  child: Text(
                                dataProvider.selectedOrder.isPaid == 1
                                    ? "PAID"
                                    : "NOT PAID",
                                style: TextStyle(
                                    fontSize: 17,
